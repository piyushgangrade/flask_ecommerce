...
class Product(Model):
    ...
    def add_product(cls, name, image_1, image_2, image_3, count, actual_price, off_percent, buy_price, 
                            style, brand_name, frame_material, usage, packaging, model_no, suitable_for, size, ideal_for, typ_e, features, case_type, dimensions_bridgesize,
